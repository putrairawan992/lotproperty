...
export const FAQ_DATA = [
  { 
    ...
    a: "XP diperoleh dari berbagai aktivitas produktif agen: Daily Login (+100 XP), input New Listing (+100 XP, Cap 300 XP/hari), upload New Content (+300 XP, Cap 300 XP/hari), Listing Promotion (+100 XP, Cap 300 XP/hari), input New Prospect (+100 XP, Cap 1.000 XP/minggu), menyelesaikan video Academy (+200 XP/video), dan New Recruit (+5.000 XP). Detail lengkap dapat dilihat di XP Guide." 
  },
  { 
    q: "Mengapa input New Prospect dibatasi maksimal 1.000 XP per minggu?", 
    a: "Berdasarkan SOP LOT Property Group, batas mingguan 1.000 XP (setara 10 prospek baru per minggu) diterapkan untuk memastikan kualitas data prospek yang dimasukkan valid, terverifikasi, dan menghindari manipulasi atau spam database oleh agen." 
  },
  { 
