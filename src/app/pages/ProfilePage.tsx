          ...
          <Card className="p-5 shadow-lg border border-border/50">
            ...
            <div className="grid grid-cols-1 @sm:grid-cols-2 @lg:grid-cols-3 gap-3">
              {[
                ...
                <div
                  key={i}
                  className={`flex items-center gap-3.5 p-3.5 rounded-2xl border border-border/30 bg-muted/10 hover:bg-muted/20 transition-all ${i === 0 ? "@sm:col-span-2 @lg:col-span-1" : ""}`}
                >
